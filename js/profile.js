...
async function handleDocumentUpload(event) {
    ...
    try {
        ...
        // TỰ ĐỘNG TẠO THƯ MỤC THEO THỂ LOẠI
const category = document.getElementById('document-category').value || 'khac';
const docFileExt = docFile.name.split('.').pop();
const docFileName = `${category}/${currentUser.id}-${Date.now()}.${docFileExt}`;
